...
const findOpenProcess = (callback = () => {}) => {
	const windowsPlist = homedir() + '/Library/Saved Application State/com.framer.x.savedState/windows.plist'
	// Library/Saved\ Application\ State/com.framer.x.savedState
	...
	const printPlist = 'Output'
	console.log(windowsPlist)
	...
	const returnNone = err => {
		...
		dialog.showErrorBox("Oops, couldn't check for open prototypes", err.toString())
		return
	}
